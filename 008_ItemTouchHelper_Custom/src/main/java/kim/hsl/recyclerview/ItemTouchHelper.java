...
public class ItemTouchHelper extends RecyclerView.ItemDecoration
    ...
    public abstract static class Callback {
        ...
        /**
         * Returns the {@link androidx.recyclerview.widget.ItemTouchUIUtil} that is used by the {@link ItemTouchHelper.Callback} class for
         * visual
         * changes on Views in response to user interactions. {@link androidx.recyclerview.widget.ItemTouchUIUtil} has different
         ...
         * </pre>
         *
         * @return The {@link androidx.recyclerview.widget.ItemTouchUIUtil} instance that is used by the {@link ItemTouchHelper.Callback}
         */
        @SuppressWarnings("WeakerAccess")
        @NonNull
